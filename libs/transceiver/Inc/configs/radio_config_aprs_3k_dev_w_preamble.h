...
// Set different TX filter coefficients for various BT products
// Value came from here: https://community.silabs.com/s/article/ezradiopro-gaussian-tx-filter-bt-factor-bandwidth-time-product-adjustment
// Note: B*T > 0.65 you need to double the Frequency Deviation, see article above for reference.

// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x3A, 0x39, 0x36, 0x31, 0x2B, 0x25, 0x1E, 0x18, 0x12 // BT = 0.25
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x3C, 0x3B, 0x38, 0x32, 0x2B, 0x24, 0x1D, 0x16, 0x10 // BT = 0.27
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x3F, 0x3D, 0x39, 0x32, 0x2A, 0x21, 0x19, 0x12, 0x0C // BT = 0.30
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x48, 0x46, 0x3F, 0x35, 0x29, 0x1E, 0x15, 0x0D, 0x08 // BT = 0.35
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x52, 0x4F, 0x45, 0x37, 0x28, 0x1A, 0x10, 0x09, 0x04 // BT = 0.40
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x5D, 0x57, 0x49, 0x37, 0x25, 0x16, 0x0C, 0x05, 0x02 // BT = 0.45
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x67, 0x60, 0x4D, 0x36, 0x21, 0x11, 0x08, 0x03, 0x01 // BT = 0.50
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x71, 0x68, 0x50, 0x34, 0x1C, 0x0D, 0x05, 0x02, 0x00 // BT = 0.55
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x7B, 0x6F, 0x52, 0x31, 0x18, 0x0A, 0x03, 0x01, 0x00 // BT = 0.60
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x43, 0x3B, 0x29, 0x17, 0x0A, 0x03, 0x01, 0x00, 0x00 // BT = 0.65 (double Fdev)
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x48, 0x3F, 0x29, 0x14, 0x08, 0x02, 0x00, 0x00, 0x00 // BT = 0.70 (double Fdev)
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x4D, 0x42, 0x29, 0x12, 0x06, 0x01, 0x00, 0x00, 0x00 // BT = 0.75 (double Fdev)
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x52, 0x45, 0x28, 0x10, 0x04, 0x01, 0x00, 0x00, 0x00 // BT = 0.80 (double Fdev)
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x57, 0x47, 0x26, 0x0E, 0x03, 0x01, 0x00, 0x00, 0x00 // BT = 0.85 (double Fdev)
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x5C, 0x49, 0x25, 0x0C, 0x02, 0x00, 0x00, 0x00, 0x00 // BT = 0.90 (double Fdev)
// #define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x62, 0x4C, 0x23, 0x0A, 0x02, 0x00, 0x00, 0x00, 0x00 // BT = 0.95 (double Fdev)
#define RF_MODEM_TX_FILTER_COEFF 0x11, 0x20, 0x09, 0x0F, 0x67, 0x4D, 0x21, 0x08, 0x01, 0x00, 0x00, 0x00, 0x00 // BT = 1.00 (double Fdev)
 ...
 // MOD_type: 3    Rsymb(sps): 1200    Fdev(Hz): 3000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2
 ...
 */
 #define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x32, 0x20, 0x1F, 0x0F, 0x10, 0x80, 0x00, 0x00, 0x00
 ...
 */
 #define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x30, 0x00, 0x01, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x00, 0xBB, 0x80, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x04  //Fdev * 2
// #define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x00, 0x12, 0xC0, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x02 // bps = 120
// #define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x07, 0x53, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x02 // bps = 12,000
 ...
 */
 //#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x75
 #define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C,0xEA  // Fdev * 2
 /*
 ...
 */
 #define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x02, 0x80, 0x00, 0x70, 0x10, 0x0C, 0xE8, 0x02, 0x09
 ...
 */
 #define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x00, 0xFB, 0xA9, 0x00, 0x7E, 0x00, 0xC2, 0x00, 0x14, 0x23, 0x80, 0xAB
 ...
 */
 #define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x72, 0x72, 0x80, 0x1A, 0xFF, 0xFF, 0x00, 0x2B, 0x0C, 0x84, 0x23
 ...
 */
 #define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8F, 0x00, 0xC7, 0x01, 0x00, 0xFF, 0x06, 0x00, 0x18, 0x40
